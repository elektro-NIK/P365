...
from .views import TrackView, GetTrackView, TrackEditView, TrackChangeStatusView, TrackDeleteView, GetTracksTableView, TableView
...
urlpatterns = [
    ...
    url(r'^table/$', login_required(TableView.as_view()),                           name='tables'),
